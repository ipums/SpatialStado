...
public class QueryCondition implements IRebuildString {
    ...
    private boolean isSpatialTopologicalJoinPredicate = false;  //sray
    ...
    public boolean isTwoRelationJoin() {    
        return (isSpatialTopologicalJoinPredicate ||  //sray
        		(isJoin() 
    ...
    //sray
    public boolean isSpatialTopologicalJoinPredicate() {
    	return isSpatialTopologicalJoinPredicate;
    }
    
    //sray
    public void setSpatialTopologicalJoinPredicate(boolean isSTJoinPred) {
    	isSpatialTopologicalJoinPredicate = isSTJoinPred;
    }
