...
public class ProducerSender {
    ...
    //------------------------------------------------------------------------------------------------------
    //sray
    public void execAtNodesThenSendtoCoord(CopyOut copyOut, StepDetail aStepDetail,
            Object jdbcLock, int sourceNodeId, int requestId)
    throws SQLException, XDBServerException {
        IntermediateSerialGeneratorClient aSerialGenerator = null;
        if (aStepDetail.getSerialColumnPosition() > 0) {
        ...
        nodeList.add(aStepDetail.getCoordNodeId());
  ...
  //sray
    public void execAtNodesThenSendtoCoordSQL(ResultSet aResultSet, StepDetail aStepDetail,
            Object jdbcLock, int sourceNodeId, int requestId)
    throws SQLException, XDBServerException {
        IntermediateSerialGeneratorClient aSerialGenerator = null;
        if (aStepDetail.getSerialColumnPosition() > 0) {
