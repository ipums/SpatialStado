...
public class Props {
    ...
    public static final String XDB_DEFAULT_JDBCDRIVER = Property.get(
           "xdb.default.jdbcdriver", "org.postgresql.driver.Driver"); //sray:TODO
    ...
    public static final int XDB_LOADER_READER_COUNT = Property.getInt(
            "xdb.loader.readercount", 1); //sray:TODO was 1

    public static final int XDB_LOADER_DATAPROCESSORS_COUNT = Property.getInt(
            "xdb.loader.dataprocessors.count", 1); //sray:TODO was 1

    public static final int XDB_LOADER_DATAPROCESSOR_BUFFER = Property.getInt(
            "xdb.loader.dataprocessor.buffer", 16192); //sray:TODO was 2048, 16192, 160961920
    ...
    public static final int XDB_DEFAULT_THREADS_POOL_INITSIZE = Property.getInt(
            "xdb.default.threads.pool.initsize", 50); //sray:TODO was 5

    public static final int XDB_DEFAULT_THREADS_POOL_MAXSIZE = Property.getInt(
            "xdb.default.threads.pool.maxsize", 100); //sray:TODO was 10
    ...
    public static final boolean XDB_TO_DEBUG =  Property.getBoolean("xdb.to_debug", false);
    public static final boolean XDB_SPATIAL_JOIN_ITERATIVE_EXEC = Property.getBoolean("xdb.spatial_join.iterative_exec", true);
    public static final String XDB_SPATIAL_JOIN_SHARDID_COLUMN_NAME = "shardid";
    public static final String XDB_SPATIAL_JOIN_SHARDID_REPL_SUBSTR = "#@#";
