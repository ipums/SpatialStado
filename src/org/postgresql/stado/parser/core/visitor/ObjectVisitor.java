...
public interface ObjectVisitor {
    ...
    *       | <SPATIAL_> <PARTITIONINGKEY_> Identifier(prn) SpatialPartitionOptions(prn) [ <LEVEL_> <INT_LITERAL> ]
    ...
    * f4 -> Identifier(prn)
    */
   public Object visit(SpatialPartitionOptions n, Object argu);
    ...
    * f0 -> <RASTER_>
    */
   public Object visit(RasterDataType n, Object argu);
    ...
    * f14 -> <PARENTHESIS_CLOSE_>
    */
   public Object visit(SelectAddRasterColumn n, Object argu);
    ...
    * f1 -> ( SQLComparitiveExpressionOperand(prn) )*
    */
   public Object visit(SQLMultiplicativeExpression n, Object argu);

   /**
    * f0 -> ( IsNullExpression(prn) | IsBooleanExpression(prn) | SQLMultiplicativeExpressionOperand(prn) )
    */
    ...
    * f0 -> <RASTER_LITERAL>
    */
   public Object visit(RasterLiteral n, Object argu);
   ...
   /**
    * f0 -> ( <ST_RASTERTYPE_> | <RASTERTYPE_> )
    * f1 -> <PARENTHESIS_START_>
    * f2 -> SQLArgument(prn)
    * f3 -> <PARENTHESIS_CLOSE_>
    */
   public Object visit(Func_ST_RASTERTYPE n, Object argu);
   ...
   /**
    * f0 -> ( <ST_RASTER_> | <RASTER_> )
    * f1 -> <PARENTHESIS_START_>
    * f2 -> SQLArgument(prn)
    * f3 -> <PARENTHESIS_CLOSE_>
    */
   public Object visit(Func_ST_RASTER n, Object argu);

   /**
    * f0 -> ( <ST_RASTERN_> | <RASTERN_> )
    * f1 -> <PARENTHESIS_START_>
    * f2 -> SQLArgument(prn)
    * f3 -> ","
    * f4 -> SQLArgument(prn)
    * f5 -> <PARENTHESIS_CLOSE_>
    */
   public Object visit(Func_ST_RASTERN n, Object argu);
