...
public class ExpressionType implements Serializable {
    ...
    // Add Raster type
    //SONI
    public static final int RASTER_TYPE = 128;
    ...
    public static boolean isNumeric(int typeCode) {
		...
		case ExpressionType.REGCLASS_TYPE:
			return false;
		case ExpressionType.RASTER_TYPE:
			return false;
        default:
    ...
    private ExpressionType checkSemanticsAndReturnOutputType(
        ...
        // SONI
        if (leftType == ExpressionType.RASTER_TYPE
        		|| rightType == ExpressionType.RASTER_TYPE) {
          exprTypeToReturn = HandleRaster(aExprTypeHelper);
          return exprTypeToReturn;
      } 
    ...
    //SONI
    // Return BOOLEAN type if  any of the expression types is RASTER
    private ExpressionType HandleRaster(ExprTypeHelper aExprTypeHelper) {
    		
    		ExpressionType exprTypeToReturn = new ExpressionType();
    		// return BOOLEAN for other operators
    		exprTypeToReturn.setExpressionType(ExpressionType.BOOLEAN_TYPE,-1, -1, -1);
    		return exprTypeToReturn;
    	}
