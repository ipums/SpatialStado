...
public class QueryProcessor implements IPreparable, IXDBSql {
        ...
        try {
            ...
            if (isFinalStep
                ...
                try {
                	...
                	//sray: is final step is spatial join duplicate elimination
                	qc = new QueryCombiner(client, aStepDetail.targetTable);
                	if (aStepDetail.isSpatialJoinDuplicateEliminationStep) {
                		aMultinodeExecutor.executeStepSpatialJoinIterative(qc, aStepDetail,
                		//aMultinodeExecutor.executeStepSpatialJoin(qc, aStepDetail,
                                coordStepDetail, nodeUsageTable, destNodeList, producerCount,
                                consumerCount);
                	}
            ...
            try {
            	if (aStepDetail.isSpatialJoinDuplicateEliminationStep || aStepDetail.isSpatialJoin) {
            		aMultinodeExecutor.executeStepSpatialJoinIterative(qc, aStepDetail,
            		//aMultinodeExecutor.executeStepSpatialJoin(qc, aStepDetail,
                            coordStepDetail, nodeUsageTable, destNodeList, producerCount,
                            consumerCount);
    ...
    throws SQLException {
        ...
        try {
            ...
            try {
            	System.out.println("setFinalResultSetOnCoordinator:" + queryString);
