...
public class NodeMessage implements Serializable, Cloneable {
    ...
    //sray
    public static final int MSG_EXECUTE_STEP_SPATIAL_JOIN = 2091;
    ...
    public static final NodeMessage getNodeMessage(int messageType) {
        ...
        //sray
        case MSG_EXECUTE_STEP_SPATIAL_JOIN:
    ...
    public int getSpatialPartitionId() {
    	return spatialPartitionId;
    }
    
    public void setSpatialPartitionId(int val) {
    	 spatialPartitionId = val;
    }
