...
public interface PartitionMap extends Serializable, Cloneable {
    ...
    //sray:TODO review if we should remove when we create the SpatialPartitionMap class 
     ...
     * specified partitions and combine results ignoring other partitions. Result
