        ...
        try {
            ...
            while (aTableRS.next()) {
                ...
                SysTable aSysTable = new SysTable(this, aTableRS
                        ...
                        aTableRS.getInt("spatialplacement"), //sray: spatial partition metadata
                        aTableRS.getString("spatialpartid"),
                        aTableRS.getInt("spatialpartcount"),
                        aTableRS.getInt("spatiallevel")
                	);
